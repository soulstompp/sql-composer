...
use sql_composer::types::{ParsedItemSql, SqlComposition, SqlCompositionAlias};
...
mod tests {
    ...
    use sql_composer::error::Result;
    use sql_composer::types::{ParsedItemSql, SqlCompositionAlias, SqlDbObject};
    ...
    fn test_bind_simple_template() -> EmptyResult {
        ...
        // can use try_into or try_from on to get a ParsedItemSql.  try_into needs explicit
        // type when we are only using it for &stmt.item
        // let stmt = ParsedItemSql::try_from("../sql-composer/src/tests/values/simple.tql")?;
        // let stmt : ParsedItemSql = "../sql-composer/src/tests/values/simple.tql".try_into()?;
        let stmt: ParsedItemSql = "../sql-composer/src/tests/values/simple.tql".try_into()?;
    ...
    fn test_bind_include_template() -> EmptyResult {
        ...
        let stmt: ParsedItemSql = "../sql-composer/src/tests/values/include.tql".try_into()?;
    ...
    fn test_count_command() -> EmptyResult {
        ...
        let stmt = ParsedItemSql::parse(":count(src/tests/values/double-include.tql);", None)?;
    ...
    fn test_union_command() -> EmptyResult {
        ...
        let stmt = ParsedItemSql::parse(":union(../sql-composer/src/tests/values/double-include.tql, ../sql-composer/src/tests/values/include.tql, ../sql-composer/src/tests/values/double-include.tql);", None)?;
    ...
    fn test_include_mock_multi_value_bind() -> EmptyResult {
        ...
        let stmt = ParsedItemSql::parse("SELECT * FROM (:compose(../sql-composer/src/tests/values/double-include.tql)) AS main WHERE col_1 in (:bind(col_1_values EXPECTING MIN 1)) AND col_3 IN (:bind(col_3_values EXPECTING MIN 1));", None)?;
    ...
    fn test_mock_db_object() -> EmptyResult {
        ...
        let stmt = ParsedItemSql::parse("SELECT * FROM main WHERE col_1 in (:bind(col_1_values EXPECTING MIN 1)) AND col_3 IN (:bind(col_3_values EXPECTING MIN 1));", None)?;
